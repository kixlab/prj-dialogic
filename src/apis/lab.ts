...
export const getDialogue = async (data: any) => {
  return {
    "dialogue_1": {
      ...
      "learning_objective": "The goal of this conversation is to help the student, Emily, understand the concept of compounds and molecules and their differences. By the end of the interaction, she should be able to confidently distinguish between molecules and compounds, as well as provide and explain examples of both.",
      "patterns": [
        [
          2,
          3
      ...
      "teaching_scenario": "The tutor uses cognitive conflict by challenging Emily's understanding with examples and follows through with metacognitive prompting by encouraging her to articulate her thought process. The tutor also uses cognitive prompting to draw on Emily's prior knowledge.",
